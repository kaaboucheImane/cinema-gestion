      ...
      <div class="row content">
        <div class="col-sm-8  ">
              <div class="col-sm-4 col-md-4">
                  <h3 style="margin-top: 2.5em; color: #28235d;">Films Récents</h3>
                  <hr >
                    <?php
                         $con=new PDO("mysql:host=localhost;dbname=ecine-1","root","");
                         $req=$con->query("SELECT * FROM film_de_jour,session,salle where  film_de_jour.id=session.id_film and session.id_salle=salle.id LIMIT 0,4");
                         while ($row=$req->fetch()) {
                           $titre=$row['title'];
                    ?>
              ...
              <div class="col-sm-8 col-md-8 text-left">
                    ...
                    <div class="thumbnail principal-post">
                       ...
                       <div class="caption">
                          <h3 style=" color: #28235d;"><?php echo $row['title'];?></h3>
                          <hr>
                          <span class="date-of-post"><h4><small><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo $row['date_de _sortie'];?> Duree :<?php echo date("h",$row['duree'])."h".date("i",$row['duree'])."min";?> Numero de Salle :11<?php ?> Langue : Anglais<?php ?></p></small></h4></span>
                          ...
                          <h3 style="margin-top: 2.5em; color: #28235d;">Galerie</h3>
                          <hr>
                          <div class="row">
                          ...
                          <h3>Bande-annonce</h3>
                          <hr style="margin-top: 2.5em; color: #28235d;">
                          <?php
                             $con=mysqli_connect('localhost','root','','ecine-1');
                             $titre=$_POST['titre'];
                             $sql="SELECT*FROM movie,genre,realisateur,langue where movie.genre_id=genre.GenreID and movie.realisateur_id=realisateur.id and  movie.langue_id=langue.id and  title='$titre'";
                          ...
                          <h3 style="margin-top: 2.5em; color: #28235d;">Héros</h3>
                          <?php
                             $con=mysqli_connect('localhost','root','','ecine-1');
                             $titre=$_POST['titre'];
                         ...
                         <h3 style="margin-top: 2.5em; color: #28235d;">Commentaire</h3>
                         <hr>
                         <form action="comment.php" method="post">
                            ...
                            <div class="form-group">
                              <textarea type="password" class="form-control" name="msg" placeholder="Message"></textarea>
                            </div>
