...
<body style=" ">
  ...
  <div class="container-fluid text-center" style="margin-top: 3em;">    
      <div class="row content">
        <div class="col-sm-8  ">
              <div class="col-sm-4" >
                  <h3 style="color: #28235d;">Films Récents</h3>
                  <hr >
              ...
              <div class="col-sm-8 col-md-8 text-left">
                    ...
                    <div class="thumbnail principal-post">
                       ...
                       <div class="caption">
                          ...
                          <hr>
                          <span class="date-of-post"><h4><small><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo $row['date_de _sortie'];?> Duree : <?php echo date("h",$row['duree'])."h".date("i",$row['duree'])."min";?> Numero de Salle :10<?php ?> Langue : Anglais</p></small></h4></span>
                          ...
                          ?>
                          <h3 style=" color: #28235d;">Galerie</h3>
                          <hr>
                          ...
                          <h3 style="color: #28235d;">Bande-annonce</h3>
                          <hr>
                          ...
                          <h3 style="color: #28235d;">Héros</h3>
                         ...
                         <h3  style="color: #28235d;">Commentaire</h3>
                         <hr>
