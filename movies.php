        ...
        <div class="col-sm-8  "> 
          <div class="row">
              <?php
                   ...
                   $results_per_page=12;
                   $sql="SELECT*FROM movie,genre,langue  where genre.GenreID=movie.genre_id and langue.id=movie.langue_id  ";
                   ...
                   $sql="SELECT*FROM movie,genre,langue  where genre.GenreID=movie.genre_id and langue.id=movie.langue_id  LIMIT ".$this_page_first_result.",".$results_per_page;
                   $res=mysqli_query($con,$sql);
        ...
        <?php
           echo '<ul class="pagination">';
            for ($page=1; $page <=$number_of_pages ; $page++) { 
              echo '<li class="act">'."<a href='movies.php?page=$page'>".$page."</a></li>";
            }
            echo "</ul>";
        ?>
